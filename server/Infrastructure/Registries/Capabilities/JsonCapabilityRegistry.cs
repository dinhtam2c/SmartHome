...
using Core.Domain.Capabilities;
using Core.Domain.Devices;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace Infrastructure.Registries.Capabilities;
...
public sealed class JsonCapabilityRegistry : ICapabilityRegistry
{
    ...
    private static Dictionary<string, CapabilityDefinition> LoadDefinitions(string registryPath)
    {
        ...
        {
            LoadDefinitionsFromArray(root, registryPath, result);
        }
        ...
        {
            throw new InvalidOperationException(
                $"Capability registry root must be a JSON array or index object: {registryPath}");
        }
    ...
    private static void LoadDefinitionsFromArray(
        JsonElement entries,
        string sourcePath,
        IDictionary<string, CapabilityDefinition> definitions)
    {
        ...
        {
            AddDefinition(entry, sourcePath, definitions);
        }
    }

...
public class AppDbContext : DbContext, IAppReadDbContext, IUnitOfWork
{
    ...
    public DbSet<ActionSetAction> ActionSetActions { get; set; }
    public DbSet<ActionSetExecution> ActionSetExecutions { get; set; }
    public DbSet<ActionSetActionExecution> ActionSetActionExecutions { get; set; }

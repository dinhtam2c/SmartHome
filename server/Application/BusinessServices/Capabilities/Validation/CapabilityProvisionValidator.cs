...
using Application.UseCases.Devices.Provisioning.RegisterDeviceManifest;
using Application.Ports.Registries;
using Application.Common.Errors;

namespace Application.BusinessServices.Capabilities.Validation;

public interface ICapabilityProvisionValidator
{
    IEnumerable<DeviceEndpointModel> NormalizeAndValidate(IEnumerable<DeviceEndpointModel> endpoints);
}

public class CapabilityProvisionValidator : ICapabilityProvisionValidator
{
    private readonly ICapabilityRegistry _capabilityRegistry;

    public CapabilityProvisionValidator(ICapabilityRegistry capabilityRegistry)
    {
        _capabilityRegistry = capabilityRegistry;
    }

    public IEnumerable<DeviceEndpointModel> NormalizeAndValidate(IEnumerable<DeviceEndpointModel> endpoints)
    {

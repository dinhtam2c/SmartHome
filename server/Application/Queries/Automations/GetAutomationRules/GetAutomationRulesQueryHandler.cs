    ...
    : IRequestHandler<GetAutomationRulesQuery, IReadOnlyList<AutomationRuleListItemDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return rules
            .Select(rule => new AutomationRuleListItemDto(
                ...
                rule.Actions.Count(action => action.Section == Core.Domain.ActionSets.ActionSetSection.Main),
                rule.Actions.Count(action => action.Section != Core.Domain.ActionSets.ActionSetSection.Main),
                ...
                rule.Conditions
                    ...
                    .Select(condition => new AutomationConditionListItemDto(
                        ...
                        condition.FieldPath,
                        condition.Operator,
                        AutomationPayloadMapper.ParseValue(condition.CompareValuePayload)))
                    .FirstOrDefault(),
    ...
    private static AutomationTimeWindowListItemDto ToTimeWindowDto(Core.Domain.Automations.AutomationRule rule)
    {

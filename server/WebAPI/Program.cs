...
builder.Services.AddSingleton<IMessageHandler, GatewayStateHandler>();
builder.Services.AddSingleton<GatewayStateHandler>();
...
builder.Services.AddSingleton<IMessageHandler, DeviceSystemStateHandler>();
builder.Services.AddSingleton<DeviceSystemStateHandler>();

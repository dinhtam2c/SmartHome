...
import type {
  HomeCreateRequest, HomeCreateResponse, HomeDetailDto, HomeListItemDto, HomeUnassignedDeviceOverviewDto, HomeUpdateRequest } from "../types/homeTypes";
...
export function getHomeDevices(homeId: string, roomId?: string) {
  ...
  return api<SelectableDeviceDto[]>(`${basePath}/${homeId}/devices${suffix}`);
}

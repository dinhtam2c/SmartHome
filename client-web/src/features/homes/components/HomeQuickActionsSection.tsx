...
import type { HomeSceneSummaryDto } from "../types/homeTypes";
import { LONG_PRESS_DURATION_MS } from "@/shared/lib/interaction/interactionConstants";
import styles from "@/shared/styles/featurePage.module.css";
import pageStyles from "../pages/HomeDetailPage.module.css";

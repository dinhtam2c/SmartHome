...
import { AutomationUpsertModal } from "../AutomationUpsertModal/AutomationUpsertModal";
  ...
  return (
    <section className={styles.section}>
      ...
      <AutomationUpsertModal
        ...
        rooms={rooms}
        availableDevices={builderDevices}
        availableDevicesByRoom={builderDevicesByRoom}

import type { FloorRoom, Point } from "../types/floorTypes";
...
export function findFloorRoomIdAtPoint(rooms: FloorRoom[], point: Point) {
  const matchingRoom = [...rooms]
    .reverse()
    .find((room) => pointInPolygon(point, room.polygon));

...
import type { DeviceCapabilityDto, DeviceCapabilityHistoryPointDto } from "../types/deviceTypes";
          ...
          <CellGrid>
            {visibleCapabilityHistory.map((point, index) => (
              <Cell
                ...
                subtitle={
                  <>
                    <div>{t("state")}: {formatCapabilityState(point.state, point.capabilityId)}</div>

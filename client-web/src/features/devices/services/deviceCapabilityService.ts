...
import type { JsonSchemaObject } from "@/features/capabilities";
...
function getNumericStepConstraint(schemaRecord: Record<string, unknown>) {
  return getNumericConstraint(schemaRecord, "multipleOf", true);
}
...
function hasNumericRange(rule: OperationRule | null) {

...
import type { SelectableCapabilityDto, SelectableDeviceDto } from "@/features/capabilities";
import { isPlainObject, toSchemaFields } from "@/features/capabilities";
...
function getRegistryEntry(
  capability: SelectableCapabilityDto | null,
